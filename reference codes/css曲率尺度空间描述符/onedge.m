clear;
FileInfo1 = imfinfo('ww1.bmp');
[ImageData1,map1] = imread('ww1.bmp');
FileInfo2 = imfinfo('ww2.bmp');
[ImageData2,map2] = imread('ww2.bmp');
...
%figure(); 
 ...
 [cout1,marked_img1] = corner(ori_im1,[],[],[],0.2);
 size(cout1,1)
...
imwrite(marked_img1,'corner1.jpg');
 [cout2,marked_img2] = corner(ori_im2,[],[],[],0.2);
 size(cout2,1)
 %cout2(1,2)
  figure(2);
imshow(marked_img2);
