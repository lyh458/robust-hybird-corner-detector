clear;
close all;
FileInfo1 = imfinfo('corner2.gif');
[ImageData1,map1] = imread('corner2.gif');
FileInfo2 = imfinfo('corner2.gif');
[ImageData2,map2] = imread('corner2.gif');
...
[cout1,marked_img1] = corner(ori_im1,[],175,[],[],[],0,[]);
...
[cout2,marked_img2] = corner(ori_im2,[],175,[],[],[],1,[]);;
size(cout2,1)
%cout2(1,2)
figure(2);
imshow(marked_img2);
...
UU = SmiliarJac1(ori_im1,ori_im2,cout1,cout2);
cols1 = size(marked_img1,1);
for i = 1: size(UU,1)
